...
namespace {{{ NAMESPACE }}}
{
    public abstract class TableLoaderBase<TTable, TData> where TData : struct
    {
        ...
        public void LoadDataFromTableRoot(TTable root)
        {
            ...
            _itemsReadOnly = Array.AsReadOnly(_items);
        ...
        /// <summary>
        /// Try get a single row of data
        /// </summary>
        /// <param name="id"></param>
        /// <param name="data"></param>
        /// <returns></returns>
        public bool TryGet(int id, out TData data)
        {
            if (!_loaded)
            {
                Debug.LogError($"[TableLoader] '{AssetPath}' not loaded");
